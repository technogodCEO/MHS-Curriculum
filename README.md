...
A curriculum visualizer for MHS students - currently has all subjects, which are accessible via a dropdown menu on the current subject title. Currently working on search function. [Link.](https://mhscurriculum.vercel.app/)
